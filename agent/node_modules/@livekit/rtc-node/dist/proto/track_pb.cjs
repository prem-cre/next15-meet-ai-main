...
var track_pb_exports = {};
__export(track_pb_exports, {
...
module.exports = __toCommonJS(track_pb_exports);
...
import_protobuf.proto2.util.setEnumType(TrackKind, "livekit.proto.TrackKind", [
...
import_protobuf.proto2.util.setEnumType(TrackSource, "livekit.proto.TrackSource", [
...
import_protobuf.proto2.util.setEnumType(StreamState, "livekit.proto.StreamState", [
...
var AudioTrackFeature = /* @__PURE__ */ ((AudioTrackFeature2) => {
  ...
  AudioTrackFeature2[AudioTrackFeature2["TF_PRECONNECT_BUFFER"] = 6] = "TF_PRECONNECT_BUFFER";
  return AudioTrackFeature2;
})(AudioTrackFeature || {});
import_protobuf.proto2.util.setEnumType(AudioTrackFeature, "livekit.proto.AudioTrackFeature", [
  { no: 0, name: "TF_STEREO" },
  { no: 1, name: "TF_NO_DTX" },
...
const _CreateVideoTrackRequest = class _CreateVideoTrackRequest extends import_protobuf.Message {
  constructor(data) {
    super();
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_CreateVideoTrackRequest, a, b);
  }
};
_CreateVideoTrackRequest.runtime = import_protobuf.proto2;
_CreateVideoTrackRequest.typeName = "livekit.proto.CreateVideoTrackRequest";
_CreateVideoTrackRequest.fields = import_protobuf.proto2.util.newFieldList(() => [
...
const _CreateVideoTrackResponse = class _CreateVideoTrackResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_CreateVideoTrackResponse, a, b);
  }
};
_CreateVideoTrackResponse.runtime = import_protobuf.proto2;
_CreateVideoTrackResponse.typeName = "livekit.proto.CreateVideoTrackResponse";
_CreateVideoTrackResponse.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "track", kind: "message", T: OwnedTrack, req: true }
]);
let CreateVideoTrackResponse = _CreateVideoTrackResponse;
const _CreateAudioTrackRequest = class _CreateAudioTrackRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_CreateAudioTrackRequest, a, b);
  }
};
_CreateAudioTrackRequest.runtime = import_protobuf.proto2;
_CreateAudioTrackRequest.typeName = "livekit.proto.CreateAudioTrackRequest";
_CreateAudioTrackRequest.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "name", kind: "scalar", T: 9, req: true },
  { no: 2, name: "source_handle", kind: "scalar", T: 4, req: true }
]);
let CreateAudioTrackRequest = _CreateAudioTrackRequest;
const _CreateAudioTrackResponse = class _CreateAudioTrackResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_CreateAudioTrackResponse, a, b);
  }
};
_CreateAudioTrackResponse.runtime = import_protobuf.proto2;
_CreateAudioTrackResponse.typeName = "livekit.proto.CreateAudioTrackResponse";
_CreateAudioTrackResponse.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "track", kind: "message", T: OwnedTrack, req: true }
]);
let CreateAudioTrackResponse = _CreateAudioTrackResponse;
const _GetStatsRequest = class _GetStatsRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_GetStatsRequest, a, b);
  }
};
_GetStatsRequest.runtime = import_protobuf.proto2;
_GetStatsRequest.typeName = "livekit.proto.GetStatsRequest";
_GetStatsRequest.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "track_handle", kind: "scalar", T: 4, req: true }
]);
let GetStatsRequest = _GetStatsRequest;
const _GetStatsResponse = class _GetStatsResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_GetStatsResponse, a, b);
  }
};
_GetStatsResponse.runtime = import_protobuf.proto2;
_GetStatsResponse.typeName = "livekit.proto.GetStatsResponse";
_GetStatsResponse.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "async_id", kind: "scalar", T: 4, req: true }
]);
let GetStatsResponse = _GetStatsResponse;
const _GetStatsCallback = class _GetStatsCallback extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_GetStatsCallback, a, b);
  }
};
_GetStatsCallback.runtime = import_protobuf.proto2;
_GetStatsCallback.typeName = "livekit.proto.GetStatsCallback";
_GetStatsCallback.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "async_id", kind: "scalar", T: 4, req: true },
  { no: 2, name: "error", kind: "scalar", T: 9, opt: true },
  { no: 3, name: "stats", kind: "message", T: import_stats_pb.RtcStats, repeated: true }
]);
let GetStatsCallback = _GetStatsCallback;
const _TrackEvent = class _TrackEvent extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_TrackEvent, a, b);
  }
};
_TrackEvent.runtime = import_protobuf.proto2;
_TrackEvent.typeName = "livekit.proto.TrackEvent";
_TrackEvent.fields = import_protobuf.proto2.util.newFieldList(() => []);
let TrackEvent = _TrackEvent;
const _TrackPublicationInfo = class _TrackPublicationInfo extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_TrackPublicationInfo, a, b);
  }
};
_TrackPublicationInfo.runtime = import_protobuf.proto2;
_TrackPublicationInfo.typeName = "livekit.proto.TrackPublicationInfo";
_TrackPublicationInfo.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "sid", kind: "scalar", T: 9, req: true },
  { no: 2, name: "name", kind: "scalar", T: 9, req: true },
  { no: 3, name: "kind", kind: "enum", T: import_protobuf.proto2.getEnumType(TrackKind), req: true },
  { no: 4, name: "source", kind: "enum", T: import_protobuf.proto2.getEnumType(TrackSource), req: true },
  ...
  { no: 11, name: "encryption_type", kind: "enum", T: import_protobuf.proto2.getEnumType(import_e2ee_pb.EncryptionType), req: true },
  { no: 12, name: "audio_features", kind: "enum", T: import_protobuf.proto2.getEnumType(AudioTrackFeature), repeated: true }
]);
let TrackPublicationInfo = _TrackPublicationInfo;
const _OwnedTrackPublication = class _OwnedTrackPublication extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_OwnedTrackPublication, a, b);
  }
};
_OwnedTrackPublication.runtime = import_protobuf.proto2;
_OwnedTrackPublication.typeName = "livekit.proto.OwnedTrackPublication";
_OwnedTrackPublication.fields = import_protobuf.proto2.util.newFieldList(() => [
...
const _TrackInfo = class _TrackInfo extends import_protobuf.Message {
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_TrackInfo, a, b);
  }
};
_TrackInfo.runtime = import_protobuf.proto2;
_TrackInfo.typeName = "livekit.proto.TrackInfo";
_TrackInfo.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "sid", kind: "scalar", T: 9, req: true },
  { no: 2, name: "name", kind: "scalar", T: 9, req: true },
  { no: 3, name: "kind", kind: "enum", T: import_protobuf.proto2.getEnumType(TrackKind), req: true },
  { no: 4, name: "stream_state", kind: "enum", T: import_protobuf.proto2.getEnumType(StreamState), req: true },
  { no: 5, name: "muted", kind: "scalar", T: 8, req: true },
  { no: 6, name: "remote", kind: "scalar", T: 8, req: true }
]);
let TrackInfo = _TrackInfo;
const _OwnedTrack = class _OwnedTrack extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_OwnedTrack, a, b);
  }
};
_OwnedTrack.runtime = import_protobuf.proto2;
_OwnedTrack.typeName = "livekit.proto.OwnedTrack";
_OwnedTrack.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "handle", kind: "message", T: import_handle_pb.FfiOwnedHandle, req: true },
  { no: 2, name: "info", kind: "message", T: TrackInfo, req: true }
]);
let OwnedTrack = _OwnedTrack;
const _LocalTrackMuteRequest = class _LocalTrackMuteRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_LocalTrackMuteRequest, a, b);
  }
};
_LocalTrackMuteRequest.runtime = import_protobuf.proto2;
_LocalTrackMuteRequest.typeName = "livekit.proto.LocalTrackMuteRequest";
_LocalTrackMuteRequest.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "track_handle", kind: "scalar", T: 4, req: true },
  { no: 2, name: "mute", kind: "scalar", T: 8, req: true }
]);
let LocalTrackMuteRequest = _LocalTrackMuteRequest;
const _LocalTrackMuteResponse = class _LocalTrackMuteResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_LocalTrackMuteResponse, a, b);
  }
};
_LocalTrackMuteResponse.runtime = import_protobuf.proto2;
_LocalTrackMuteResponse.typeName = "livekit.proto.LocalTrackMuteResponse";
_LocalTrackMuteResponse.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "muted", kind: "scalar", T: 8, req: true }
]);
let LocalTrackMuteResponse = _LocalTrackMuteResponse;
const _EnableRemoteTrackRequest = class _EnableRemoteTrackRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_EnableRemoteTrackRequest, a, b);
  }
};
_EnableRemoteTrackRequest.runtime = import_protobuf.proto2;
_EnableRemoteTrackRequest.typeName = "livekit.proto.EnableRemoteTrackRequest";
_EnableRemoteTrackRequest.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "track_handle", kind: "scalar", T: 4, req: true },
  { no: 2, name: "enabled", kind: "scalar", T: 8, req: true }
]);
let EnableRemoteTrackRequest = _EnableRemoteTrackRequest;
const _EnableRemoteTrackResponse = class _EnableRemoteTrackResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_EnableRemoteTrackResponse, a, b);
  }
};
_EnableRemoteTrackResponse.runtime = import_protobuf.proto2;
_EnableRemoteTrackResponse.typeName = "livekit.proto.EnableRemoteTrackResponse";
_EnableRemoteTrackResponse.fields = import_protobuf.proto2.util.newFieldList(() => [
  { no: 1, name: "enabled", kind: "scalar", T: 8, req: true }
]);
let EnableRemoteTrackResponse = _EnableRemoteTrackResponse;
const _SetTrackSubscriptionPermissionsRequest = class _SetTrackSubscriptionPermissionsRequest extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_SetTrackSubscriptionPermissionsRequest, a, b);
  }
};
_SetTrackSubscriptionPermissionsRequest.runtime = import_protobuf.proto2;
_SetTrackSubscriptionPermissionsRequest.typeName = "livekit.proto.SetTrackSubscriptionPermissionsRequest";
_SetTrackSubscriptionPermissionsRequest.fields = import_protobuf.proto2.util.newFieldList(() => [
...
const _ParticipantTrackPermission = class _ParticipantTrackPermission extends import_protobuf.Message {
  constructor(data) {
    super();
    /**
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_ParticipantTrackPermission, a, b);
  }
};
_ParticipantTrackPermission.runtime = import_protobuf.proto2;
_ParticipantTrackPermission.typeName = "livekit.proto.ParticipantTrackPermission";
_ParticipantTrackPermission.fields = import_protobuf.proto2.util.newFieldList(() => [
...
const _SetTrackSubscriptionPermissionsResponse = class _SetTrackSubscriptionPermissionsResponse extends import_protobuf.Message {
  constructor(data) {
    super();
    import_protobuf.proto2.util.initPartial(data, this);
  }
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_SetTrackSubscriptionPermissionsResponse, a, b);
  }
};
_SetTrackSubscriptionPermissionsResponse.runtime = import_protobuf.proto2;
_SetTrackSubscriptionPermissionsResponse.typeName = "livekit.proto.SetTrackSubscriptionPermissionsResponse";
_SetTrackSubscriptionPermissionsResponse.fields = import_protobuf.proto2.util.newFieldList(() => []);
...
//# sourceMappingURL=track_pb.cjs.map